'''
Common utilities for Hailo AI applications on Raspberry Pi including GStreamer buffer processing and device detection.
Provides frame extraction functions converting GStreamer buffers to NumPy arrays for multiple video formats (RGB, NV12, YUYV).
Handles argument parsing, device architecture detection, and format conversion for computer vision pipelines.
'''
import sys
import gi
