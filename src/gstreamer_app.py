'''
Base GStreamer application framework for video processing with camera input support and callback integration.
Handles pipeline creation, buffer management, and frame display with multiprocessing support for real-time applications.
Provides foundation for computer vision applications with Raspberry Pi camera and USB webcam compatibility.
'''
...
from truck_safety.src.utils.gstreamer_helper_pipelines import get_source_type
...
class GStreamerApp:
    def __init__(self, args, user_data: app_callback_class):
        ...
        setproctitle.setproctitle("truck-safety-app")
