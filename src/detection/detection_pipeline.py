'''
GStreamer detection application using Hailo 8L for real-time object detection with YOLOv8/YOLOv10 models.
Configures inference pipeline with post-processing, tracking, and display components for vehicle detection applications.
Supports multiple Hailo architectures (Hailo8/Hailo8L) with customizable detection thresholds and batch processing.
'''
import gi
...
from truck_safety.src.utils.gstreamer_helper_pipelines import(
    QUEUE,
    SOURCE_PIPELINE,
    INFERENCE_PIPELINE,
